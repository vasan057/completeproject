...
@stop
@section('content')
<nav class="navbar navbar-default navbar-fixed-top dexel-coach-navbar">
    <div class="container-fluid">
       <div class="navbar-header">
          <a class="navbar-brand header-brand" href="#">Content &nbsp;&nbsp; &gt; </a>
       </div>
    </div>
 </nav>
...
elseif($successCount)
{
  ...
  $redirect_url = url('coach/'.$coachId.'/upload/audios');
?>
