...
.anchor-box-border{ margin-top: 30px; }
 ...
 @media(max-width: 480px){ 
    .sidebar-brand-logo img{ width: 90px; height: 90px;  }
...
<div  class="bg">
    ...
    <div class="row lrx-content">
        ...
        <div class="form-group formx-each">
                    <label for="password_confirmation" class="col-md-12 control-label">Thank you! Your password has been updated successfuly. </label>
