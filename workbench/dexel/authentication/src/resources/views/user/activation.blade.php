...
body{ height: 100%;   }
   ...
   .bg{ background:url({{asset('assets/web/images/bg_login{{-- happening_bgX --}}.jpg')}}) no-repeat top center; background-size: cover;  color:#fff;  overflow-y: auto; height: 100%;}
    ...
    .anchor-box-border{  width: 100px; background-color: transparent; border-radius: 0px; border:solid 3px #fff;
        ...
        font-weight: 200; letter-spacing: .05em;  font-family: sans-serif; font-size: 1.2em; line-height: 40px; display: block;
        margin-top: 10px;}
...
<div class="bg">
    ...
    <div class="row lrx-content">
        ...
        <div class="form-group formx-each">
                    <label for="password_confirmation" class="col-md-12 control-label">Thank you, your account has been activated successfuly!  <br/><br/><a class="anchor-box-border" href={{url('/login')}}>login</a></label>
                </div>
        </div>
    </div>
</div>
