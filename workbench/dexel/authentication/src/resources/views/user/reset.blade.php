...
body{ height: 100%;   }
   ...
   /* .streak-header{ display: block; width: 100%; height: 250px; background:url({{asset('assets/web/images/streak_bottom_1.png')}})no-repeat bottom center; background-size: 100% 100%; position: absolute;     bottom: 0; left: 0; }
    ...
    .landing_logo {    position: absolute;    left: 150px;    top: 40px;    width: 320px;    z-index: 2;}
    ...
    .sidebar-brand-logo{    position: fixed;    top: 10px;    width: 70px;    height: 191px;    margin: 0;    padding: 0;
    ...
    input{ height: 50px!important; font-weight: 400; letter-spacing: .05em; 
...
<div  class="bg" >
    ...
    <div class="row lrx-content">
	    ...
	    <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-12 lrx-content-login">
